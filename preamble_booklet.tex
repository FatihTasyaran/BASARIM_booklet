...
%----------------------------------------
\newenvironment{abstract_basarim}[8] %{date}{track}{room}{link}{toc_author}{title}{author}{affiliation}{type}
{%\filbreak %avoid page break
        ...
        \chead{#2}
        \rhead{#3}
        \cfoot{BAŞARIM 2022\\Sabancı Üniversitesi, Altunizade Dijital Kampüs, Istanbul}
        \rfoot{\thepage}
        
      	{\renewcommand{\baselinestretch}{3.5}  \Large \bfseries #5 \renewcommand{\baselinestretch}{1} }
        	
       	{\bfseries \itshape #6} \newline\newline {\noindent #7} 
       	\textcolor{mygray}{#8}

        \addcontentsline{toc}{section}{{\bfseries #5}\newline{\itshape #4}}
...
%----------------------------------------
% basarim abstract environment for only first page with header
%----------------------------------------
\newenvironment{abstract_basarim_first}[8] %{date}{track}{room}{toc_author}{title}{author}{affiliation}{type}
{%\filbreak %avoid page break
    
        \clearpage\pagestyle{fancy}
        \fancyhf{}
        \renewcommand{\headrulewidth}{0pt}
        \chapter{Bildiri Listesi}
	...
	{\bfseries \itshape #6} \newline\newline {\noindent #7}
        ...
        \addcontentsline{toc}{section}{{\bfseries #5}\newline{\itshape #4}}
        \fancypagestyle{plain}{\cfoot{Sabancı Üniversitesi, Altunizade Dijital Kampüs, Istanbul}
        \rfoot{\thepage}}
...
\AddEverypageHook{%
\ifthenelse{%
	\isodd{\thepage} \AND  \thepage>1 \AND \thepage<61% if odd page but not front page
	}{%
	\backgroundsetup{
...
%
\ifthenelse{% 
	\NOT \isodd{\thepage} \AND \NOT \thepage=61% if even page AND NOT THE LAST PAGE
	}{%
	\backgroundsetup{
		color=\secondarycolor,
